                              ...
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:35px 10px 30px;font-family:'Lato',sans-serif;" align="left">
                                <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                  <p style="font-size: 14px; line-height: 140%; text-align: center;">
                                    <span style="font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;">{{ $title }}</span>
                                  </p>
                                </div>
                              </td>
                            </tr>
                              ...
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 40px;font-family:'Lato',sans-serif;" align="left">
                                <div
                                  ...
                                  <p style="font-size: 14px; line-height: 140%;">
                                    <span style="font-size: 18px; line-height: 25.2px; color: #666666;">Hello {{ $receiver_name }},</span>
                                  </p>
